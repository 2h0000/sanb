...
import 'vault_unlock_service_dev.dart';
import 'vault_service.dart';

/// Provider for VaultUnlockService (Dev Mode)
final vaultUnlockServiceProvider = Provider<VaultUnlockServiceDev>((ref) {
  final keyManager = ref.watch(keyManagerProvider);
  return VaultUnlockServiceDev(keyManager: keyManager);
});
